...
namespace WhatsMyStatus_DnD_.Views
{
    public partial class StatusView : UserControl
    {
        ...
        {
            //var t = cb_ActiveStatus;
            //var temp = DataContext;
            //var character = GetCharacter();
            //// Try see if our character is already affected by this status
            //var charStatus = WmsFakeDb.Database.CharacterStatuses.FirstOrDefault(x => x.Character.Equals(character) && x.Status.Equals((WmsCharacterStatus)DataContext));
            //if (charStatus != null)
            //{
            //    statusRoundView.DataContext = charStatus;
